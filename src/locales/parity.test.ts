...
// CONTEXT.md "Completude") — trava as 9 namespaces contra regressão futura:
// falha se um par de PR adicionar uma chave a um idioma e esquecer o outro.
...
describe("i18n namespace parity (pt-BR ⇄ en)", () => {
  ...
  it("todas as 9 namespaces declaradas em i18n.ts estão presentes nos dois idiomas", () => {
