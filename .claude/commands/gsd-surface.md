...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/gsd-cards/.claude/.gsd-surface.json`
(sibling to `/home/user/gsd-cards/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/gsd-cards/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/gsd-cards/.claude/skills`).
...
`/home/user/gsd-cards/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/gsd-cards/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/gsd-cards/.claude/.gsd-surface.json`
Install profile marker: `/home/user/gsd-cards/.claude/.gsd-profile`
Skill dirs: `/home/user/gsd-cards/.claude/skills/gsd-*/`
Engine module: `/home/user/gsd-cards/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/gsd-cards/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
