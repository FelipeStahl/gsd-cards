...
<execution_context>
@/home/user/gsd-cards/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/gsd-cards/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
