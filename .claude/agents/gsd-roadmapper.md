...
Reference full template: `/home/user/gsd-cards/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/gsd-cards/.claude/gsd-core/templates/state.md`.
