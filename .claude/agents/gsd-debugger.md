...
<required_reading>
@/home/user/gsd-cards/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/gsd-cards/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/gsd-cards/.claude
                  → checks /home/user/gsd-cards/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/gsd-cards/.claude/gsd-core
                  → writes to /home/user/gsd-cards/.claude/gsd-core/hooks/
...
@/home/user/gsd-cards/.claude/gsd-core/references/debugger-bug-taxonomy.md
...
@/home/user/gsd-cards/.claude/gsd-core/references/debugger-repro-hardening.md
...
@/home/user/gsd-cards/.claude/gsd-core/references/debugger-semantic-recall.md
...
@/home/user/gsd-cards/.claude/gsd-core/references/thinking-models-debug.md
...
@/home/user/gsd-cards/.claude/gsd-core/references/debugger-sbfl.md
...
- Read @/home/user/gsd-cards/.claude/gsd-core/references/common-bug-patterns.md
...
@/home/user/gsd-cards/.claude/gsd-core/references/debugger-rca-branching.md
...
@/home/user/gsd-cards/.claude/gsd-core/references/debugger-fix-acceptance.md
...
@/home/user/gsd-cards/.claude/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@/home/user/gsd-cards/.claude/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
