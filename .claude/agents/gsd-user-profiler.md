...
<reference>
@/home/user/gsd-cards/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/gsd-cards/.claude/gsd-core/references/user-profiling.md` to load:
