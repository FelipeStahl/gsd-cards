...
<!-- For checkpoint task examples and patterns, see @/home/user/gsd-cards/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/user/gsd-cards/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/user/gsd-cards/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/user/gsd-cards/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
