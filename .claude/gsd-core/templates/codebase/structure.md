...
- Usage: Reference from command with `@/home/user/gsd-cards/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/user/gsd-cards/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/user/gsd-cards/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
