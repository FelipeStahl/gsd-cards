...
```
Agent(
  prompt="Read /home/user/gsd-cards/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/gsd-cards/.claude/gsd-core/templates/VALIDATION.md`
