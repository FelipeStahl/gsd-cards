...
<template>
@/home/user/gsd-cards/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/user/gsd-cards/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/user/gsd-cards/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/user/gsd-cards/.claude/gsd-core/workflows/diagnose-issues.md
