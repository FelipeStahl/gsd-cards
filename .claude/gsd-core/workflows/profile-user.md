...
Key references:
- @/home/user/gsd-cards/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/home/user/gsd-cards/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/user/gsd-cards/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/user/gsd-cards/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/user/gsd-cards/.claude/gsd-core/USER-PROFILE.md" "/home/user/gsd-cards/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/user/gsd-cards/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/user/gsd-cards/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/home/user/gsd-cards/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/user/gsd-cards/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/user/gsd-cards/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/user/gsd-cards/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/user/gsd-cards/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/user/gsd-cards/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/user/gsd-cards/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/user/gsd-cards/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/user/gsd-cards/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /home/user/gsd-cards/.claude/CLAUDE.md
```
