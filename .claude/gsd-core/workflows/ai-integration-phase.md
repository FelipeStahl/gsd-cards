...
<required_reading>
@/home/user/gsd-cards/.claude/gsd-core/references/ai-frameworks.md
@/home/user/gsd-cards/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/user/gsd-cards/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/user/gsd-cards/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/user/gsd-cards/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/user/gsd-cards/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/user/gsd-cards/.claude/agents/gsd-eval-planner.md for instructions.
